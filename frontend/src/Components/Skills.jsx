...
const Skills = () => {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "ExpressJS", src: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/express/express-original.svg" },
      ...
      { name: "Semantic UI", src: "https://raw.githubusercontent.com/Semantic-Org/Semantic-UI-React/master/docs/public/logo.png" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Apache Hadoop", src: "https://upload.wikimedia.org/wikipedia/commons/0/0e/Hadoop_logo.svg" },
