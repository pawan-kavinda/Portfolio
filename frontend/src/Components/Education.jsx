...
const Education = () => {
  return (
    <div className="text-white px-5 bg-black mx-auto max-w-full " id="about">
        ...
        <motion.div initial={{x:100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:0.5,delay:1}} className='mb-[20px] bg-gray-800 p-4 rounded-3xl max-w-[600px] mx-auto hover:shadow-none overflow-hidden shadow-lg shadow-green-700'>
            <p className='text-lg md:text-3xl'>Higher Studies</p>
            <p className='text-gray-500'>Faculty of Engineering University of Ruhuna(2021-Present)</p>
            <p className='text-gray-300'>Computer engineering</p>
        </motion.div>
        <div className='h-[50px] w-[2px] bg-slate-400 my-1 mx-auto '></div>
        <motion.div initial={{x:-100,opacity:0}} animate={{x:0,opacity:1}} transition={{duration:0.5,delay:1.5}}  className='mb-[20px] bg-gray-800 p-4 rounded-3xl max-w-[600px] mx-auto transform  hover:shadow-none overflow-hidden shadow-lg shadow-yellow-700'>
            <p className='text-xl md:text-3xl'>G.C.E Advanced Level</p>
            <p className='text-gray-500'>Central College Anuradhapura(2019)</p>
            <p className='text-gray-300'>Science Stream (Maths)</p>
